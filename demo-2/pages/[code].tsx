...
export default function Home() {
  ...
  const HOMEPAGE_METADATA_WITH_REFERRAL = {
    ...
    ogImageWidth: '1200',
    ogImageHeight: '628',
    ogTitle: (inviterReferralCode: any) => `DemoCard - ${inviterReferralCode} invited you to earn up to 8% Democoin Rewards.`,
    ...
    twitterTitle: (inviterReferralCode: any) => `DemoCard - ${inviterReferralCode} invited you to earn up to 8% Democoin Rewards.`
  };
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta property="og:title" content={ogMetadata.ogTitle(inviterReferralCode)} />
        <meta
          property="og:url"

...
export default function Home() {
  ...
  const HOMEPAGE_METADATA_WITH_REFERRAL = {
    ...
    ogImageWidth: '1200',
    ogImageHeight: '628',
    ogTitle: 'DogeCard - up to 8% Democoin Rewards.',
    ogUrl: inviterReferralCode =>
    ...
    twitterTitle: inviterReferralCode => `DemoCard - ${inviterReferralCode} invited you to earn up to 8% Democoin Rewards.`
  };
  ...
  const HOMEPAGE_METADATA_WITHOUT_REFERRAL = {
    ...
    ogImageHeight: '628',
    ogTitle: 'DogeCard - up to 8% Democoin Rewards.',
    ogUrl: inviterReferralCode => 'https://dev-dogecard.d2ap16azx4464o.amplifyapp.com/',
    themeColor: '#5cd95b',
    ogImage: 'https://dev-dogecard.d2ap16azx4464o.amplifyapp.com/logos/home-preview.png',
    twitterTitle: inviterReferralCode => 'DemoCard - up to 8% Democoin Rewards.'
  };
  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta
          name="twitter:site"
          content={`DemoCard Marketing Website`}
        />
        <meta
        ...
        <meta
          ...
          content={`DemoCard Preview Image`}
        />
